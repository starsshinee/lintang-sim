    ...
    <div class="card shadow">
        <div class="card-body p-4">
            <div class="table-responsive">
                ...
                <a href="{{ route('dashboard.galeri.create') }}" class="btn btn-success my-4"><i class="ti ti-plus"></i> Tambah
                    Data</a>
                    ...
                    <tbody>
                        @foreach ($data as $value => $item)
                            <tr class="">
                                ...
                                <td><img src="{{ asset('storage/' . $item->foto_galeri) }}" style="width:5rem"
                                        alt=""></td>
                                <td>
                                    <div class="d-flex gap-2 h-100">
                                        <div class="col-auto">
                                            <a href="{{ route('dashboard.galeri.show', $item->id) }}"
                                        ...
                                        <div class="col-auto">
                                            <a href="{{ route('dashboard.galeri.edit', $item->id) }}"
                                                class="btn btn-warning btn-sm"><i class="ti ti-edit fw-bolder"></i></a>
                                        </div>
                                        <div class="col-auto">
                                            <form action="{{ route('dashboard.galeri.destroy', $item->id) }}"
                                                method="post">
                                                @csrf
                                                @method('delete')
